...
package net.bafeimao.umbrella.support.network;
...
public class PacketWrapper {
    private static Map<String, MessageType> messageTypeNameInstanceMap = new HashMap<String, MessageType>();
    ...
    static {
        ...
        for (EnumValueDescriptor descriptor : valueDescriptors) {
            messageTypeNameInstanceMap.put(descriptor.getName().replace("_", ""), MessageType.valueOf(descriptor));
        }
    }
    ...
    private static MessageType getMessageType(MessageLiteOrBuilder message) {
        ...
        return messageTypeNameInstanceMap.get(key.toUpperCase());
    }
}
